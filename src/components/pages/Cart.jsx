      ...
      return (
        <div className="p-3">
          <div className="min-h-[50vh] flex flex-col items-center">
            ...
            <div>
              <button className="w-40 h-12 bg-blue-500 text-white border rounded-lg text-2xl mt-5">
                Check Out
              </button>
            </div>
          </div>
      ...
      return (
        <div className="p-3">
          <div className="min-h-[50vh] flex flex-col items-center">
            ...
            <div>
              <button className="w-240 h-20 bg-blue-500 text-white border rounded-lg text-5xl mt-28">
                Check Out
              </button>
            </div>
          </div>
